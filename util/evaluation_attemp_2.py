        ...
        for pos in pos_list:
            ...
            if neighborhood is not None:
                ...
                feed = {
                    ...
                    input_neighborhood_handle: feed[input_neighborhood_handle] + neighborhoods,
                    input_neighborhood_lengths_handle: feed[input_neighborhood_lengths_handle] + neighborhood_length
                }
